...
def main():
    ...
    servers_needed, total_servers = dist_index.calculate_server_coverage()
    print(f"Server coverage: {servers_needed} out of {total_servers} servers needed for 90% of results")
